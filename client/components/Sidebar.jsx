...
const styles = {
  ...
  navContainer: `flex-1`,
  profileButton:
    "flex rounded-3xl p-2 items-center mb-6 cursor-pointer bg-[#192734] hover:bg-[#22303c] ",
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.profileButton}>
        ...
        <div className={styles.details}>
          <div className={styles.name}>Sourabh</div>
          <div className={styles.handle}>0xe7Dd...321</div>
        </div>
